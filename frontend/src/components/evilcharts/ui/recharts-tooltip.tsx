...
// Chart tooltip, adapted from Evil Charts (evilcharts.com). Theme tokens are
// mapped to this site's CSS variables.
...
const variantMap: Record<TooltipVariant, string> = {
  ...
  "frosted-glass": "bg-[var(--surface-2)]/70 backdrop-blur-sm",
}
...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "grid min-w-32 items-start gap-1.5 border border-[var(--border)] px-2.5 py-1.5 text-xs shadow-xl",
