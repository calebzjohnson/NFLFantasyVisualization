...
// weeks. Not wired to real data yet. Square, like Compare Players, since the
...
function TrendingPlayersPlaceholder({ position }: { position: PositionGroup }) {
  return (
    <Panel title="Trending Players" expandable>
      <div className="m-4 flex aspect-square items-center justify-center rounded-lg border-2 border-dashed border-[var(--border)]">
